...
class IO
{
     ...
     * @return bool
     */
    public function ask(array $lines, $default = '')
    {
        if ($this->verbosity < 1) {
            return $default;
        }
        ...
        return $this->io->ask($question . PHP_EOL . $prompt, $default);
    }
     ...
     * @return bool
     */
    public function askConfirmation(array $lines, $default = true)
    {
        if ($this->verbosity < 1) {
            return $default;
        }
    ...
    public function select(array $lines, array $choices, $default, $attempts, $errorMessage, $multiselect)
    {
        if ($this->verbosity < 1) {
            return $default;
        }
        ...
        return $this->io->select($question, $choices, $default, $attempts, $errorMessage, $multiselect);
